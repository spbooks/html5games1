...
var level = new _Level2.default(w * 2, h * 2);
squizz.pos = { x: level.w / 2, y: level.h / 2 };
var camera = new Camera(squizz, { w: w, h: h }, { w: level.w, h: level.h });
...
function addBaddies(level) {
  ...
  // Horizontal baddies
  for (var i = 0; i < 5; i++) {
    var b = baddies.add(new _Baddie2.default(32 * 5, 0));
    b.pos.y = (level.h / 5 | 0) * i + level.tileH * 2;
  }
  // Vertical baddies
  for (var _i = 0; _i < 10; _i++) {
    var _b = baddies.add(new _Baddie2.default(0, 32 * 5));
