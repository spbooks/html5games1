...
var Squizz = function (_TileSprite) {
  ...
  function Squizz() {
    ...
    _this.speed = math.rand(20, 100);

    // Animation variables
    _this.rate = 0.15 - 0.1 * _this.speed / 100;
    _this.curTime = 0;
    _this.curFrame = 0;
    _this.frames = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 2, y: 0 }, { x: 3, y: 0 }];
    _this.frame = _this.frames[_this.curFrame];
    return _this;
  }
...
var mouse = new MouseControls(renderer.view);
