...
},{"./Container.js":1,"./renderer/CanvasRenderer.js":10,"./utils/screenCapture.js":12}],3:[function(require,module,exports){
"use strict";
...
},{"./Sprite.js":3}],7:[function(require,module,exports){
"use strict";
...
},{"./Container.js":1,"./Game.js":2,"./Sprite.js":3,"./Text.js":4,"./Texture.js":5,"./TileSprite.js":6,"./controls/KeyControls.js":7,"./controls/MouseControls.js":8,"./renderer/CanvasRenderer.js":10,"./utils/math.js":11}],10:[function(require,module,exports){
"use strict";
...
var Squizz = function (_TileSprite) {
  ...
  function Squizz() {
    ...
    _this.speed = math.randf(0.05, 0.15);
    return _this;
  }
...
},{"../../pop/index.js":9}],14:[function(require,module,exports){
"use strict";
...
var balls = scene.add(new Container());
for (var i = 0; i < 20; i++) {
  var squizz = balls.add(new _Squizz2.default());
  squizz.pos = {
    x: math.rand(w - 100),
    y: math.rand(h - 50)
  };
...
},{"../pop/index.js":9,"./entities/Squizz.js":13}]},{},[14]);
