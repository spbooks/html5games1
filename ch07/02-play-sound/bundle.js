...
},{"./Container.js":3,"./utils/math.js":20}],3:[function(require,module,exports){
"use strict";
...
},{"./Container.js":3,"./renderer/CanvasRenderer.js":16,"./utils/screenCapture.js":22}],5:[function(require,module,exports){
"use strict";
...
},{"./utils/Vec.js":18}],6:[function(require,module,exports){
"use strict";
...
},{"./utils/Vec.js":18}],7:[function(require,module,exports){
"use strict";
...
},{"./utils/Vec.js":18}],9:[function(require,module,exports){
"use strict";
...
},{"../utils/entity.js":19}],16:[function(require,module,exports){
"use strict";
...
},{"../Rect.js":5,"./math.js":20}],20:[function(require,module,exports){
"use strict";
...
var texture = new Texture("res/images/tennis_ball.png");

var TennisBall = function (_Sprite) {
  _inherits(TennisBall, _Sprite);

  function TennisBall(speed) {
    _classCallCheck(this, TennisBall);

    var _this = _possibleConstructorReturn(this, (TennisBall.__proto__ || Object.getPrototypeOf(TennisBall)).call(this, texture));

    _this.rad = 70;
    _this.vel = new Vec(speed, 0);
    return _this;
  }
...
var _TennisBall = require("./entities/TennisBall.js");

var _TennisBall2 = _interopRequireDefault(_TennisBall);
...
var balls = [{ x: 0, y: h / 2, dir: 1 }, { x: w, y: h / 2, dir: -1 }].map(function (d) {
  var p = game.scene.add(new _TennisBall2.default(600 * d.dir));
  p.pos.copy(d).add({ x: -p.rad, y: -p.rad });
  return p;
});

var plop = new Sound("./res/sounds/plop.mp3");

game.run(function (dt) {
  var _balls$map = balls.map(function (p) {
    var pos = p.pos,
        vel = p.vel;
    ...
    return pos.x;
      ...
      _balls$map2 = _slicedToArray(_balls$map, 2),
      x1 = _balls$map2[0],
      x2 = _balls$map2[1];
...
},{"../pop/index.js":14,"./entities/TennisBall.js":23}]},{},[24]);
