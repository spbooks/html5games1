...
},{"./Container.js":3,"./utils/math.js":21}],3:[function(require,module,exports){
"use strict";
...
},{"./Container.js":3,"./renderer/CanvasRenderer.js":16,"./utils/screenCapture.js":23}],5:[function(require,module,exports){
"use strict";
...
},{"./utils/Vec.js":19}],6:[function(require,module,exports){
"use strict";
...
},{"./utils/Vec.js":19}],7:[function(require,module,exports){
"use strict";
...
},{"./utils/Vec.js":19}],9:[function(require,module,exports){
"use strict";
...
},{"../utils/entity.js":20}],16:[function(require,module,exports){
"use strict";
...
},{"./Sound.js":17}],19:[function(require,module,exports){
"use strict";
...
},{"../Rect.js":5,"./math.js":21}],21:[function(require,module,exports){
"use strict";
...
var Game = _index2.default.Game,
    ...
    SoundPool = _index2.default.SoundPool;


var game = new Game(800, 400);

// Try this as a "new Sound()"", rather than a "new SoundPool()":
var plops = new SoundPool("./res/sounds/plop.mp3", { volume: 0.2 }, 3);

game.scene = new _TitleScreen2.default(game);

var rate = 0.1;
var next = rate;
game.run(function (dt, t) {
  if (t > next) {
    next = t + rate;
    plops.play();
  }
...
},{"../pop/index.js":14,"./screens/TitleScreen.js":25}],25:[function(require,module,exports){
"use strict";
...
var TitleScreen = function (_Container) {
  ...
  function TitleScreen(game) {
    ...
    var title = _this.add(new Text("SoundPoolin'", {
