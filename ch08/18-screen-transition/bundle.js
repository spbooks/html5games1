...
var Level = function (_TileMap) {
  ...
  function Level() {
    ...
    var tileSize = 48;
    var tileIndexes = [{ id: "empty", x: 0, y: 2, walkable: true }, { id: "wall", x: 1, y: 3 }, { id: "wall3D", x: 3, y: 3 }, { id: "cloud", x: 0, y: 5, walkable: true, cloud: true }, { id: "bridge", x: 5, y: 5, bridge: true }];
    ...
    var _this = _possibleConstructorReturn(this, (Level.__proto__ || Object.getPrototypeOf(Level)).call(this, level.map(function (i) {
      return Object.assign({}, tileIndexes[i]);
  ...
  _createClass(Level, [{
    ...
    value: function makeDisappearingTile(t) {
      ...
      var getTile = function getTile(name) {
        return _this2.tileIndexes.find(function (t) {
          return t.id === name;
        });
      };
...
},{"../pop/index.js":19}],31:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":19}],35:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":19,"./Bullet.js":32}],36:[function(require,module,exports){
"use strict";
...
function title() {
  game.setScene(new _TitleScreen2.default(game, controls, startGame), 0);
}
function startGame() {
  game.setScene(new _GameScreen2.default(game, controls, title));
}
title();
game.run();

},{"../pop/index.js":19,"./screens/GameScreen.js":37,"./screens/TitleScreen.js":38}],37:[function(require,module,exports){
"use strict";
...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls, onGameOver) {
    ...
    _this.fx = camera.add(new Container());
    ...
    _this.pe = _this.fx.add(new ParticleEmitter(25, p));
...
},{"../../pop/index.js":19,"../Level.js":30,"../entities/Bat.js":31,"../entities/Pickup.js":33,"../entities/Player.js":34,"../entities/Totem.js":35}],38:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":19,"../ui.js":39}],39:[function(require,module,exports){
"use strict";
