...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls) {
    ...
    _this.player = _this.add(new _Player2.default(controls));
    _this.player.pos.x = _this.w / 2 - 16;
    return _this;
  }
...
},{"../pop/index.js":14,"./entities/Player.js":22}],22:[function(require,module,exports){
"use strict";
