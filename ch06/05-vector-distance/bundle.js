...
},{"./Container.js":3,"./renderer/CanvasRenderer.js":16,"./utils/screenCapture.js":20}],5:[function(require,module,exports){
"use strict";
...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls) {
    ...
    var velocity = _this.w / 3; // X seconds to cross the screen.
    _this.ctd = _this.add(new _CrashTestDummy2.default(velocity));
    _this.ctd.pos.y = game.h / 2 - 10;

    _this.timer = _this.add(new Text("time", { font: "24px sans-serif", fill: "#fff", align: "center" }));
    _this.timer.pos.set(_this.w / 2, 20);
    _this.reset();
    return _this;
  }
  ...
  _createClass(GameScreen, [{
    ...
    key: "update",
    value: function update(dt) {
      _get(GameScreen.prototype.__proto__ || Object.getPrototypeOf(GameScreen.prototype), "update", this).call(this, dt);
      var ctd = this.ctd,
...
},{"../pop/index.js":14,"./entities/CrashTestDummy.js":22}],22:[function(require,module,exports){
"use strict";
...
var CrashTestDummy = function (_TileSprite) {
  ...
  function CrashTestDummy(vel) {
    ...
    _this.vel = new Vec(vel, 0);
    _this.pivot = { x: 24, y: 24 };
    return _this;
  }
...
},{"../pop/index.js":14,"./GameScreen.js":21}]},{},[23]);
