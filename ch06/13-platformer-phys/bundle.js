...
},{"../pop/index.js":14,"./Level.js":23,"./entities/Bat.js":24,"./entities/Pickup.js":26,"./entities/Player.js":27,"./entities/Totem.js":28}],23:[function(require,module,exports){
"use strict";
  ...
  _createClass(Player, [{
    ...
    value: function update(dt, t) {
      ...
      if (!this.falling && !r.hits.down) {
        ...
        var left = map.tileAtMapPos(leftFoot).frame.walkable;
        var right = map.tileAtMapPos(rightFoot).frame.walkable;
        if (left && right) {
          this.falling = true;
        }
      }
...
},{"../../pop/index.js":14,"./Bullet.js":25}],29:[function(require,module,exports){
"use strict";
...
},{"../pop/index.js":14,"./GameScreen.js":22}]},{},[29]);
