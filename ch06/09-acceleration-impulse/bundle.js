...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls) {
    ...
    var timer = _this.add(new Text("0", {
      font: "20px sans-serif",
      fill: "#fff",
      align: "center"
    }));
    timer.pos.set(_this.w / 2, 20);

    var bounds = { x: 0, y: 0, w: _this.w, h: _this.h };
    _this.ctd = _this.add(new _CrashTestDummy2.default(bounds, function (t) {
      return timer.text = t;
    }));
...
var CrashTestDummy = function (_TileSprite) {
  ...
  function CrashTestDummy(bounds, onBounce) {
