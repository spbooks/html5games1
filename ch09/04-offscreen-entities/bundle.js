...
var _isInCameraView = require("./isInCameraView.js");

var _isInCameraView2 = _interopRequireDefault(_isInCameraView);
    ...
    value: function render(container) {
      ...
      function renderRec(container, camera) {
        ...
        container.children.forEach(function (child) {
          ...
          if (camera && !(0, _isInCameraView2.default)(child, camera)) {
            return;
          }
          ctx.save();
          if (child.alpha) {
...
},{"./isInCameraView.js":22}],22:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = isInCameraView;
function isInCameraView(e, camera) {
  var tmpDbg = 50; // To show rendering doesn't happen outside box.
  return e.pos.x + e.w >= -camera.pos.x + tmpDbg && e.pos.x <= -camera.pos.x + camera.w - tmpDbg && e.pos.y + e.h >= -camera.pos.y + tmpDbg && e.pos.y <= -camera.pos.y + camera.h - tmpDbg;
}
...
},{"../Assets.js":2}],24:[function(require,module,exports){
"use strict";
...
},{"../utils/math.js":28}],25:[function(require,module,exports){
"use strict";
...
},{"./Sound.js":23}],26:[function(require,module,exports){
"use strict";
...
var game = new Game(48 * 16, 48 * 9);
var controls = {
  keys: new KeyControls()
};

function startGame() {
  game.setScene(new _GameScreen2.default(game, controls), 0);
}

startGame();
game.run();

},{"../pop/index.js":19,"./screens/GameScreen.js":33}],33:[function(require,module,exports){
"use strict";
...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls) {
    ...
    var player = new TileSprite(texture, 48, 48);
    player.frame.x = 1;

    var mapW = 1000;
    var mapH = 100;

    var map = new TileMap([].concat(_toConsumableArray(Array(mapW * mapH))).map(function () {
      return {
        x: math.rand(0, 3),
        y: math.rand(1, 3)
      };
    }), mapW, mapH, 48, 48, texture);

    player.pos.set(map.w / 2, map.h / 2);

    _this.controls = controls;
    _this.game = game;
    _this.camera = _this.add(new Camera(null, { w: game.w, h: game.h }, { w: map.w, h: map.h }));

    _this.camera.setSubject(player);
    _this.camera.add(map);
    _this.player = _this.camera.add(player);
