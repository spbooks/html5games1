...
},{"./math.js":16}],16:[function(require,module,exports){
"use strict";
...
var a = scene.add(new _Mouse2.default(new KeyControls()));
var b = scene.add(new _Cheese2.default());
...
game.run(function () {
  ...
  if (a.pos.x + a.w >= b.pos.x && a.pos.x < b.pos.x + b.w && a.pos.y + a.h >= b.pos.y && a.pos.y < b.pos.y + b.h) {
    relocate(b);
  }
});
