...
var GameScreen = function (_Container) {
  ...
  function GameScreen(game, controls, onGameOver) {
    ...
    for (var i = 0; i < 3; i++) {
      _this.randoBat(baddies.add(new _Bat2.default(function () {
        return map.findFreeSpot(false);
      })));
    }
    ...
    _this.scoreText.pos = { x: game.w / 2, y: 180 };
    return _this;
  }
...
},{"../pop/index.js":13,"./Level.js":21,"./entities/Bat.js":22,"./entities/Pickup.js":24,"./entities/Player.js":25,"./entities/Totem.js":26}],21:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":13}],26:[function(require,module,exports){
"use strict";
...
},{"../../pop/index.js":13,"./Bullet.js":23}],27:[function(require,module,exports){
"use strict";
...
},{"../pop/index.js":13,"./GameScreen.js":20}]},{},[27]);
