...
},{"./Container.js":3,"./utils/math.js":17}],3:[function(require,module,exports){
"use strict";
...
},{"./Container.js":3,"./renderer/CanvasRenderer.js":15,"./utils/screenCapture.js":18}],5:[function(require,module,exports){
"use strict";
...
},{"./Camera.js":2,"./Container.js":3,"./Game.js":4,"./Rect.js":5,"./Sprite.js":6,"./Text.js":7,"./Texture.js":8,"./TileMap.js":9,"./TileSprite.js":10,"./controls/KeyControls.js":11,"./controls/MouseControls.js":12,"./movement/deadInTracks.js":14,"./renderer/CanvasRenderer.js":15,"./utils/entity.js":16,"./utils/math.js":17}],14:[function(require,module,exports){
"use strict";
...
},{"../utils/entity.js":16}],15:[function(require,module,exports){
"use strict";
...
},{"../Rect.js":5,"./math.js":17}],17:[function(require,module,exports){
"use strict";
...
},{"../pop/index.js":13,"./Level.js":20,"./entities/Pickup.js":21,"./entities/Player.js":22}],20:[function(require,module,exports){
"use strict";
...
var Texture = _index2.default.Texture,
    TileSprite = _index2.default.TileSprite,
    deadInTracks = _index2.default.deadInTracks;
...
var Player = function (_TileSprite) {
  ...
  _createClass(Player, [{
    ...
    value: function update(dt, t) {
      ...
      var xo = x * dt * speed;
      var yo = y * dt * speed;
      var r = deadInTracks(this, map, xo, yo);
      if (r.x !== 0 && r.y !== 0) {
        r.x /= Math.sqrt(2);
        r.y /= Math.sqrt(2);
      }
...
},{"../pop/index.js":13,"./GameScreen.js":19}]},{},[23]);
